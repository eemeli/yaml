...
function (_Collection) {
  ...
  function YAMLSeq(doc, node) {
    ...
    if (node.type === _Node.Type.FLOW_SEQ) {
      ...
      for (var i = 0; i < seq.items.length; ++i) {
        ...
        switch (item.type) {
          ...
          case _Node.Type.SEQ_ITEM:
            ...
            if (item.hasProps) doc.errors.push(new _errors.YAMLSyntaxError(item, 'Sequence items cannot have tags or anchors before the - indicator'));
            break;
